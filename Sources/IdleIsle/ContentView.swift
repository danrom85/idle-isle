...
struct ContentView: View {
    ...
    @ObservedObject private var settingsModel = AppSettingsModel.shared
    ...
    var body: some View {
        SpriteView(scene: scene)
            ...
            .onAppear {
                ...
                scene.setSoundEnabled(settingsModel.settings.soundEnabled)
            }
            .onChange(of: settingsModel.settings) { _, newSettings in
                scene.setSoundEnabled(newSettings.soundEnabled)
            }
