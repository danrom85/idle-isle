    ...
    private func updateAmbientEvents(by delta: TimeInterval) {
        ...
        if state.dayPhase == .night {
            candidates = state.cloudCover < 0.55
                ? [.shootingStar, .fishJumps, .none, .none]
                : [.fishJumps, .none, .none, .none]
        } else if state.tideLevel < 0.38 {
            candidates = [.gullPasses, .coconutFalls, .fishJumps, .none, .none]
            ...
            candidates = [.gullPasses, .fishJumps, .coconutFalls, .none]
        }
